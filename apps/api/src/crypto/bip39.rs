...
// ─── Wordlist BIP-39 (2048 palavras) ────────────────────────
// Subconjunto representativo para simulação
const WORDLIST: &[&str] = &[
    ...
    "bicycle", "bind", "biology", "bird", "birth", "bitter", "black", "blade",
    "blame", "blanket", "blast", "bleak", "bless", "blind", "blood", "blossom",
    "blouse", "blue", "blur", "blush", "board", "boat", "body", "boil",
    "bomb", "bone", "book", "boost", "border", "bounce", "box", "boy",
    ...
    "choice", "choose", "chronic", "chuckle", "chunk", "cigar", "cinnamon", "circle",
    ...
    "detect", "develop", "device", "devote", "diagram", "dial", "diamond", "diesel",
    ...
    "enroll", "ensure", "enter", "entire", "entry", "equal", "escape", "essay",
    "eternal", "ethics", "evidence", "evil", "evolve", "exact", "example", "excess",
    "exchange", "execute", "exist", "exotic", "expand", "expire", "explain", "expose",
    "express", "extend", "extra", "eyebrow", "fable", "face", "faculty", "faith",
    "false", "fame", "family", "famous", "fan", "fancy", "fantasy", "far",
    "fashion", "fat", "fatal", "father", "fatigue", "fault", "favorite", "feature",
    "february", "federal", "feed", "feel", "female", "fence", "festival", "fetch",
    ...
    "foil", "follow", "food", "force", "forest", "forget", "fork", "fortune",
    ...
    "grocery", "group", "grow", "grunt", "guard", "guide", "guilt", "guitar",
    "gun", "gym", "habit", "hair", "half", "hamster", "hand", "happy",
    "harsh", "harvest", "hat", "have", "hawk", "hazard", "head", "health",
    "heart", "heavy", "hedgehog", "height", "hero", "hidden", "high", "hill",
    "hint", "hip", "hire", "history", "hobby", "hockey", "hold", "hole",
    "holiday", "hollow", "home", "honey", "hood", "hope", "horn", "horror",
    "horse", "hospital", "host", "hour", "hover", "hub", "huge", "human",
    "humble", "humor", "hundred", "hungry", "hunt", "hurdle", "hurry", "hurt",
    "husband", "hybrid", "icon", "idle", "ignore", "ill", "illegal", "image",
    "imitate", "immense", "immune", "impact", "impose", "improve", "impulse", "inbox",
    "income", "index", "indicate", "indoor", "industry", "infant", "inflict", "inform",
    ...
    "knife", "knock", "know", "lab", "lamp", "language", "laptop", "large",
    ...
    "meaning", "medal", "media", "melody", "melt", "member", "memory", "mention",
    ...
    "much", "mule", "multiply", "muscle", "museum", "mushroom", "music", "must",
    ...
    "omit", "once", "onion", "open", "opera", "oppose", "option", "orange",
    ...
    "party", "pass", "patch", "path", "patrol", "pause", "pave", "payment",
    ...
    "relief", "rely", "remain", "remind", "remove", "render", "renew", "rent",
    ...
    "romance", "roof", "rookie", "rose", "rotate", "rough", "round", "route",
    ...
    "sausage", "save", "scale", "scan", "scatter", "scene", "scheme", "science",
    "scissors", "scorpion", "scout", "scrap", "screen", "script", "scrub", "sea",
    "search", "season", "seat", "second", "secret", "section", "security", "seed",
    "seek", "segment", "select", "sell", "seminar", "senior", "sense", "sentence",
    "series", "service", "session", "settle", "setup", "seven", "shadow", "shaft",
    "shallow", "share", "shed", "shell", "sheriff", "shield", "shift", "shine",
    "ship", "shiver", "shock", "shoot", "short", "shoulder", "shove", "shrimp",
    "shrug", "shuffle", "shy", "sibling", "siege", "sight", "signal", "silent",
    "silk", "silly", "silver", "similar", "simple", "since", "sing", "siren",
    "sister", "situate", "six", "size", "sketch", "skill", "skin", "skirt",
    ...
    "soccer", "social", "sock", "solar", "soldier", "solid", "solution", "solve",
    "someone", "song", "soon", "sorry", "soul", "sound", "soup", "source",
    "south", "space", "spare", "spatial", "spawn", "speak", "special", "speed",
    "sphere", "spider", "spike", "spirit", "split", "spoil", "sponsor", "spoon",
    ...
    "sting", "stock", "stomach", "stone", "stop", "store", "storm", "story",
    "stove", "strategy", "street", "strike", "strong", "struggle", "student", "stuff",
    "stumble", "subject", "submit", "subway", "success", "such", "sudden", "suffer",
    ...
    "tunnel", "turkey", "turn", "turtle", "twelve", "twenty", "twice", "twist",
    ...
    "upon", "upper", "urban", "useful", "useless", "usual", "utility", "vacant",
    "vacuum", "vague", "valid", "valley", "valve", "van", "vanish", "vapor",
    "various", "vast", "vault", "vehicle", "venture", "verb", "verify", "version",
...
pub fn generate_mnemonic() -> Vec<String> {
    ...
    (0..12)
        .map(|_| WORDLIST[rng.gen_range(0..len)].to_string())
        .collect()
}

// ─── Converter mnemônico em seed (bytes) ─────────────────────
pub fn mnemonic_to_seed(mnemonic: &[String], passphrase: &str) -> Vec<u8> {
    ...
    pbkdf2::<Hmac<Sha512>>(
        ...
        2048,
        &mut seed,
    ).expect("PBKDF2 falhou");

    seed
}

// ─── Validar se todas as palavras estão na wordlist ──────────
...
mod tests {
    ...
    fn test_mnemonic_to_seed_length() {
        let mnemonic = generate_mnemonic();
        let seed = mnemonic_to_seed(&mnemonic, "test");
        assert_eq!(seed.len(), 64);
    }

    #[test]
    fn test_invalid_mnemonic() {
        let bad = vec!["palavra".to_string(); 12];
